...
- Original generated image files in `assets/world1/` and `assets/world2/`.
- Synthesized audio rendered by `js/audio/sfx.js`.

The `assets/world1/` and `assets/world2/` stills were generated for Savoria on 2026-08-29. Their matching world thumbnails served as internal art-direction references. The generated stills contain no Nintendo artwork, characters, or logos.
