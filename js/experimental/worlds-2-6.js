...
export const EXPERIMENTAL_LEVELS = [
  level(2, 1, 'Nori Narrows', 'sushi', 260, [
    ['run', 12, { coins: 4, deco: 'sakura' }], ['gap', 4, { arc: 4 }], ['roll', 16, { coins: 1, enemy: 'meatball' }], ['run', 8, { shooter: 1, deco: 'archgate', decoS: 1.1 }], ['river', 12], ['bonus', 0], ['checkpoint'], ['plats', 4, { coins: 1 }], ['tier', 14, { item: 'speed' }], ['gap', 6, { mover: 1 }], ['run', 10, { coins: 4, deco: 'sakura', decoS: 1.3 }], ['goal'],
  ]),
  level(2, 2, 'Wasabi Falls', 'sushi', 280, [
    ['run', 10, { coins: 3, deco: 'archgate' }], ['steps', 3], ['blocks', 4, { enemy: 'meatball' }], ['river', 16, { flyer: 1 }], ['run', 8, { item: 'shield', deco: 'bamboo', decoS: 1.4 }], ['checkpoint'], ['gap', 6, { plat: 1, arc: 5 }], ['roll', 14, { enemy: 'meatball' }], ['plats', 5, { coins: 1 }], ['pillars', 3], ['goal'],
  ]),
